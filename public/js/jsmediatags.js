(function (y) {
    "object" === typeof exports && "undefined" !== typeof module ? module.exports = y() : "function" === typeof define && define.amd ? define([], y) : ("undefined" !== typeof window ? window : "undefined" !== typeof global ? global : "undefined" !== typeof self ? self : this).jsmediatags = y()
})(function () {
        ...
        1: [function (f, p, q) {
            ...
            f = function (e) {
                ...
                l(d, [{
                    ...
                    key: "loadRange", value: function (c, a) {
                        setTimeout(a.onSuccess, 0)
                    }
                }, {
                    key: "getByteAt", value: function (c) {
                ...
                l(c, [{
                    ...
                    key: "loadRange", value: function (a, b) {
                        ...
                        c.onerror = c.onabort = function (a) {
                            if (b.onError) b.onError({type: "blob", info: c.error})
                        };
            ...
            f = function () {
                ...
                m(f, [{
                    key: "addData", value: function (e, d) {
                        ...
                        if (-1 === a.startIx) this._fileData.splice(a.insertIx || 0, 0, {offset: e, data: d}); else {
                    ...
                    key: "_concatData", value: function (e, d) {
                    ...
                    key: "_getChunkRange", value: function (e, d) {
            ...
            f = function (a) {
                ...
                l(b, [{
                    ...
                    key: "_nextBlock", value: function (a, b, d, c, e) {
                        var h = this;
                        if (127 < d) if (h._commentOffset) e.onSuccess(); else e.onError({
                            type: "loadData",
                    ...
                    key: "_parseData", value: function (a, b) {
                        ...
                        for (var d, g, e, n, x, f, t = 0; t < b; t++) {
                            var w = a.getLongAt(h, !1), l = a.getStringWithCharsetAt(h + 4, w, "utf-8").toString(),
                                m = l.indexOf("=");
                        ...
                        this._pictureOffset && (f = a.getLongAt(this._pictureOffset,
                            !0), b = this._pictureOffset + 4, h = a.getLongAt(b, !0), t = b + 4, b = a.getStringAt(t, h), h = t + h, t = a.getLongAt(h, !0), w = h + 4, h = a.getStringWithCharsetAt(w, t, "utf-8").toString(), t = w + t + 16, w = a.getLongAt(t, !0), a = a.getBytesAt(t + 4, w, !0), f = {
                            format: b,
                            type: c[f],
                            description: h,
                            data: a
                        ...
                        return {
                            type: "FLAC",
                            version: "1",
                            tags: {title: d, artist: g, album: e, track: n, genre: x, picture: f}
                        }
                    }
                }], [{
            ...
            f = function (d) {
                ...
                l(c, [{
                    ...
                    key: "_parseData", value: function (a, b) {
                        var d = a.getSize() - 128, h = a.getStringWithCharsetAt(d + 3, 30).toString(),
                        ...
                        a = {
                            type: "ID3",
                            version: n,
                            tags: {title: h, artist: c, album: r, year: u, comment: f, genre: 255 > a ? e[a] : ""}
                        };
                        b && (a.tags.track = b);
                        return a
                    }
            ...
            f("./MediaFileReader");
            var d = f("./StringUtils"), c = f("./ArrayFileReader"), a = {
            ...
            f = function () {
                ...
                e(d, null, [{
                    key: "getFrameReaderFunction", value: function (a) {
                    ...
                    key: "_getFrameHeaderSize", value: function (a) {
                        a = a.major;
                    ...
                    key: "_getFrameDescription", value: function (b) {
                        return b in a ? a[b] : "Unknown"
                    }
                }, {
                    key: "getUnsyncFileReader", value: function (a, b, d) {
                        a = a.getBytesAt(b, d);
                        for (b = 0; b < a.length - 1; b++) 255 === a[b] && 0 === a[b + 1] && a.splice(b + 1, 1);
                        return new c(a)
                    }
                }]);
                return d
            ...
            f = function (c) {
                ...
                l(a, [{
                    ...
                    key: "_parseData", value: function (a, c) {
                        ...
                        var l = a.getByteAt(g + 4), m = a.isBitSetAt(g + 5, 7), n = a.isBitSetAt(g + 5, 6),
                            x = a.isBitSetAt(g + 5, 5), p = a.getSynchsafeInteger32At(g + 6);
                        g += 10;
                        if (n) if (4 === f) {
                    ...
                    key: "_getFrameData",
                    value: function (a, c) {
                        for (var b = 0, d; d = c[b]; b++) if (d in a) return a = a[d] instanceof Array ? a[d][0] : a[d], a.data
                    }
                }, {
            ...
            f = function (a) {
                ...
                l(b, [{
                    ...
                    key: "_isContainerAtom", value: function (a) {
                        return 0 <= ["moov", "udta", "meta", "ilst"].indexOf(a)
                    }
                }, {
                    key: "_canReadAtom", value: function (a) {
                        return "----" !== a
                    }
                }, {
                    key: "_parseData", value: function (a, b) {
                    ...
                    key: "_readAtom", value: function (a, b, d, c, e, f, n) {
                        n = void 0 === n ? "" : n + "  ";
                        for (var g = d; g < d + c;) {
            ...
            f = function () {
                ...
                m(e, [{
                    ...
                    key: "_init", value: function (d) {
                        throw Error("Must implement init function");
                    }
                }, {
                    key: "loadRange", value: function (d, c) {
                    ...
                    key: "getBytesAt", value: function (d, c) {
                        for (var a = Array(c), b = 0; b < c; b++) a[b] = this.getByteAt(d + b);
                        return a
                    }
                }, {
                    key: "isBitSetAt", value: function (d, c) {
                        return 0 != (this.getByteAt(d) & 1 << c)
                    }
                }, {
                    key: "getSByteAt", value: function (d) {
                        d = this.getByteAt(d);
                    ...
                    key: "getSShortAt", value: function (d, c) {
                        d = this.getShortAt(d, c);
                        return 32767 < d ? d - 65536 : d
                    }
                }, {
                    key: "getLongAt", value: function (d, c) {
                        var a = this.getByteAt(d), b = this.getByteAt(d + 1), e = this.getByteAt(d + 2);
                    ...
                    key: "getSLongAt", value: function (d, c) {
                    ...
                    key: "getStringAt", value: function (d, c) {
                        for (var a = [], b = d, e = 0; b < d + c; b++, e++) a[e] = String.fromCharCode(this.getByteAt(b));
                        return a.join("")
                    }
                }, {
                    key: "getStringWithCharsetAt", value: function (d, c, a) {
                    ...
                    {
                        key: "getCharAt", value: function (d) {
                            return String.fromCharCode(this.getByteAt(d))
                        }
                    }, {
                        key: "getSynchsafeInteger32At", value: function (d) {
                            var c = this.getByteAt(d), a = this.getByteAt(d + 1), b = this.getByteAt(d + 2);
                            return this.getByteAt(d + 3) & 127 | (b & 127) << 7 | (a & 127) << 14 | (c & 127) << 21
                        }
                    }], [{
                    key: "canReadFile", value: function (d) {
            ...
            f = function () {
                ...
                m(f, [{
                    ...
                    key: "_loadData", value: function (e, d) {
                        throw Error("Must implement _loadData function");
                    }
                }, {
                    key: "_parseData", value: function (e, d) {
                    ...
                    key: "_expandShortcutTags", value: function (e) {
                        if (!e) return null;
                        for (var d =
                            [], c = this.getShortcuts(), a = 0, b; b = e[a]; a++) d = d.concat(c[b] || [b]);
                        return d
                    }
                }], [{
                    key: "getTagIdentifierByteRange", value: function () {
            ...
            q = function (d) {
                ...
                l(c, [{
                    ...
                    key: "_roundRangeToChunkMultiple", value: function (a) {
                    ...
                    key: "_makeXHRRequest", value: function (a, b, d) {
                        ...
                        "undefined" !==
                        typeof e.onload ? (e.onload = f, e.onerror = function () {
                    ...
                    key: "_setRequestHeader", value: function (a, b, d) {
            ...
            f("./MediaFileReader");
            q = f("./NodeFileReader");
            var d = f("./XhrFileReader"), c =
                f("./BlobFileReader"), a = f("./ArrayFileReader");
            f("./MediaTagReader");
            ...
            var k = [], r = [], u = function () {
                ...
                e(a, [{
                    ...
                    key: "_findFileReader", value: function () {
                        for (var a = 0; a < k.length; a++) if (k[a].canReadFile(this._file)) return k[a];
                ...
                e(a, null, [{
                    ...
                    key: "EXPERIMENTAL_avoidHeadRequests", value: function () {
                        d.setConfig({avoidHeadRequests: !0})
                    }
                }, {
                    key: "setDisallowedXhrHeaders", value: function (a) {
                        d.setConfig({disallowedXhrHeaders: a})
                    }
                },
                    {
                        key: "setXhrTimeoutInSec", value: function (a) {
                            d.setConfig({timeoutInSec: a})
                        }
                    }]);
                return a
            }();
